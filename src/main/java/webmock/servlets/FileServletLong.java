 ...
 */
public class FileServletLong extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.filePath = getServletContext().getRealPath("/WEB-INF/xml");
        ...
        throws ServletException, IOException
    {
        ...
        //@TODO: Remove debug
        System.out.println("FileServletLong: Retrieving file " + filePath + "\\" + requestedFile);
        ...
        if (!file.exists()) {
        	 //@TODO: Remove debug
            System.out.println("FileServletLong: File does not exists.");
        ...
        //@TODO: Remove debug
        System.out.println("FileServletLong: File does exists.");
